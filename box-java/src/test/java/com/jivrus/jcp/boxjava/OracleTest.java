...
public class OracleTest {
    ...
    public void setUp() {
        ...
        configMap.put("host", "database-5.c2djb5rbn5rs.us-east-2.rds.amazonaws.com");
    ...
    public void testGetBoxConfigToken() {
        try {
            System.out.println("Calling Oracle config token");
    ...
    public void testGetBoxObjectFunctions() throws Exception {
        Map<String, Object> functions = BoxGateway.getObjectFunctions(boxId, "user", token);
    ...
    public void testGetAttributes() {
        ...
        try {
            result = BoxGateway.executeFunction(boxId, "getattributes", token, Collections.singletonMap("object", "user"));
